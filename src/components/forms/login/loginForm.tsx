  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end">
        <Link href="/auth/recover-credentials" className="text-sm text-dark font-regular cursor-pointer hover:underline" aria-label="Esqueceu a senha?">
          Esqueceu a senha?
        </Link>
      </div>
      <Button label="Entrar" variant="default" type="submit" className="w-full" />
      <Link
        href="/auth/register"
      ...
      >
        <div className="flex flex-col items-start justify-start flex-1">
          ...
          <p className="text-[0.9rem]">Crie uma conta, não espere mais.</p>
        </div>
